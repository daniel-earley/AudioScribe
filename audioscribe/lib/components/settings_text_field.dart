...
class SettingsEditableTextField extends StatefulWidget {
  ...
  @override
  _InlineEditableTextFieldState createState() => _InlineEditableTextFieldState();
}
                	...
                	child: Padding(
                  	...
                  	child: _isEditing
                      	...
                      	: InkWell(
                          	...
                          	child: Text(
                            	_controller.text.isEmpty ? 'Enter your text' : _controller.text,
              	...
              	_isEditing
                  	? Padding(
                          ...
                          if (_controller.text.isNotEmpty) {
                            	Future.microtask(() => FocusScope.of(context).requestFocus(new FocusNode()));
                          	}
                        	},
                      	)
					)
