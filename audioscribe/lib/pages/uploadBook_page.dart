	...
	Future<void> _submitBook() async {
		if (_formKey.currentState!.validate()) {
			...
			if (widget.text.endsWith('.mp3')) {
				...
				contentSummary = "trying not to use up tokens so delete this before pushing and use gpt";

				// generate the audio book for current context
				audioBookPath = await createAudioBook(widget.text, _titleController.text);
			}
