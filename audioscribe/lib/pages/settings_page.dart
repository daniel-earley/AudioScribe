...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void signOut() async {
    userInfo.UserModel userModel = userInfo.UserModel();
    String userId = getCurrentUserId();
    // update logged in status for user
    await userModel.updateLoggedInStatus(userId, false);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SettingsEditableTextField(
                            initialText: _username, titleText: 'Username'),

                        const SizedBox(height: 15.0),

                        SettingsEditableTextField(
                            initialText: _user?.username ?? "loading...",
                            titleText: 'Email'),

                        const SizedBox(height: 15.0),

                        const SettingsEditableTextField(
                            initialText: '********', titleText: 'Password'),
