...
class _AudioPlayerPage extends State<AudioPlayerPage> {
	...
	void initState() {
		...
		print('audio files: ${widget.audioBookPath} ${widget.audioFileList}');
	}
					...
					child: Padding(
						...
						child: Column(
							children: [
								...
								// currently listening to chapter
								const SizedBox(height: 10.0),
								PrimaryInfoText(
									text: 'Currently listening to Chapter: ${currentChapter + 1}',
									color: Colors.white,
									fontSize: 16.0,
									fontWeight: FontWeight.w500),

								// conditionally render the audiocontrols based on audio file type
								widget.audioBookPath.isNotEmpty
								? AudioControls(audioBookPath: widget.audioBookPath)
								: AudioControls(
