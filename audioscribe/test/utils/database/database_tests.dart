...
void main() {
  test('database ops work as expected', () async {
    ...
    User userA = User(userId: Random().nextInt(1000000).toString(), username: "George1212", bookLibrary: [], loggedIn: true);
    User userB = User(userId: Random().nextInt(1000000).toString(), username: "Alex2121", bookLibrary: [], loggedIn: false);
